...
## -*- texinfo -*-
## @deftypefn {Function File} {@var{yi} =} pmm_griddatan (@var{x}, @var{y}, @var{xi}, @var{method}, @var{options})
## 
...
function yi = pmm_griddatan (x, y, xi, method, varargin)
  ...
  if (n != ni || size (y, 1) != m || size (y, 2) != 1)
    error ("pmm_griddatan: dimensional mismatch");
  endif
  ...
  elseif (strcmp (method, "linear"))
    ...
    error ("pmm_griddatan: unknown interpolation method");
  endif
